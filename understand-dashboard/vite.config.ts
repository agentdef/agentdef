...
function graphFileCandidates(fileName: string): string[] {
  ...
  return [
    ...
    // This standalone copy of the dashboard lives one level under the
    // project root (<project-root>/understand-dashboard), so the project's
    // .understand-anything/ directory is one level up from process.cwd().
    path.resolve(process.cwd(), `../.understand-anything/${fileName}`),
    path.resolve(process.cwd(), `../../../.understand-anything/${fileName}`),
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      "@understand-anything/core/schema": path.resolve(__dirname, "./vendor/core/schema.ts"),
      "@understand-anything/core/search": path.resolve(__dirname, "./vendor/core/search.ts"),
      "@understand-anything/core/types": path.resolve(__dirname, "./vendor/core/types.ts"),
    },
  },
